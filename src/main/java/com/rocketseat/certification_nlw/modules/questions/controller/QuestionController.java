...
public class QuestionController {
    ...
    static AlternativesResultDTO mapAlternativeDTO(AlternativesEntity alternativesResultDTOS){
        return AlternativesResultDTO.builder()
                .id(alternativesResultDTOS.getId())
                .description(alternativesResultDTOS.getDescription()).build();
